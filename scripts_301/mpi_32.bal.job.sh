...
#
#PBS -V
#PBS -l nodes=4:r301:ppn=8
#PBS -l walltime=2:00:00
#PBS -N 301_radix.mpi_32.bal
#PBS -m bea
#PBS -e out_301/mpi_32.bal.err
#PBS -o out_301/mpi_32.bal.out
...
for g in ${G[@]}; do
	...
	for size in ${SIZES[@]}; do
		...
		for threads in ${THREADS[@]}; do
			...
			mkdir -p results_301/mpi.bal
			output=results_301/mpi.bal/${g}_s${size}_t${threads}
